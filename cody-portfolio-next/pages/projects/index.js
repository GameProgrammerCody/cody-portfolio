...
export default function Projects() {
    ...
    // Add “Featured” if any visible project is featured
    const hasFeatured = visibleProjects.some(p => p.featured)
                            ...
                            {["All", ...categories].map(t => {
                                ...
                                return (
                                    <button
                                        key={t}
                                        onClick={() => setTab(t)}
                                        className={`relative px-3 py-1 rounded-xl border transition-all duration-300 ease-in-out ${tab === t
