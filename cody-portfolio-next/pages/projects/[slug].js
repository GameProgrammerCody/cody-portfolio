...
export default function Project() {
  ...
  const next = idx >= 0 && idx < data.projects.length - 1 ? data.projects[idx + 1] : null
    ...
    >
      ...
      {project?.media?.gallery?.length > 0 && (
        <section className="scroll-mt-24 mt-20 fade-up-stagger">
          ...
          {/* Lightbox with direction-aware animation */}
          {lightbox.open && (
            <div
            ...
            >
              ...
              >
                <img
                  ...
                  alt=""
                  className={`w-full rounded-xl shadow-[0_0_25px_rgba(0,255,255,0.3)] transition-all duration-400 ease-out ${
                    fadeImage
                      ? direction === 'next'
