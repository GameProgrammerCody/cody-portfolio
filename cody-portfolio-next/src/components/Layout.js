      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 py-10 grid md:grid-cols-3 gap-8 text-sm">
          ...
          <div className="flex flex-col space-y-2">
            ...
            <Link href="/" className="text-white/60 hover:text-cyan-300 transition-colors">Home</Link>
            <Link href="/projects" className="text-white/60 hover:text-cyan-300 transition-colors">Projects</Link>
    ...
    <div className="relative group">
      <button
        ...
        className={`relative p-2 rounded-full border backdrop-blur-sm transition-all duration-500
          ${enabled
            ? "border-cyan-400/50 text-cyan-200 bg-black/40 shadow-[0_0_15px_rgba(0,255,255,0.25)] animate-[pulse_4s_ease-in-out_infinite]"
